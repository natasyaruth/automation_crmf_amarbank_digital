...
import com.tunaiku.keyword.UpdatableBCrypt as UpdatableBCrypt
import internal.GlobalVariable as GlobalVariable

hash = UpdatableBCrypt.bcrypt.hash(""+ password +"")
...
def request = (RequestObject) findTestObject('API/CRM/API_createUser')
