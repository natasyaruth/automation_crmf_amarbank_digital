...
WebUI.openBrowser((((('https://' + CryptoUtil.decode(CryptoUtil.getDefault(GlobalVariable.authUserBackOffice))) + ':') + CryptoUtil.decode(CryptoUtil.getDefault(GlobalVariable.authPassBackOffice))) + '@') + GlobalVariable.siteUrlBackOff.substring(
        8))
/* Set window is maximize*/
WebUI.maximizeWindow()

/* Set navigate to setup URL */
WebUI.navigateToUrl(GlobalVariable.siteUrlBackOff)