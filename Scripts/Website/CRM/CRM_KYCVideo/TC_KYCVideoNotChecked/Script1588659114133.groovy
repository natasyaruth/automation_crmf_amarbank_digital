...
WebUI.click(findTestObject('Website/CRM/KYC_Management/KYC_Video/NotCheckedDukcapil/BtnCivilDataCheck'))

WebUI.click(findTestObject('Website/CRM/KYC_Management/KYC_Video/NotCheckedDukcapil/BtnSave'))

WebUI.click(findTestObject('Website/CRM/KYC_Management/KYC_Video/NotCheckedDukcapil/BtnBackSuccessModal'))
