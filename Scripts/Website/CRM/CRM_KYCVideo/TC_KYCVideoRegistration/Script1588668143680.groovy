...
TestObject sectionCheckbox = new TestObject().addProperty('text', ConditionType.CONTAINS, textVerificationCheckbox)

if (WebUI.verifyElementPresent(sectionCheckbox, 20, FailureHandling.OPTIONAL) == true) {
    ...
    WebUI.click(findTestObject('Website/CRM/KYC_Management/KYC_Video/CheckBoxConfirmation/ChkCardDeliveryAddress'), FailureHandling.OPTIONAL)
    ...
    WebUI.click(findTestObject('Website/CRM/KYC_Management/KYC_Video/CheckBoxConfirmation/ChkKtpImage'), FailureHandling.OPTIONAL)
    
    WebUI.verifyElementChecked(findTestObject('Website/CRM/KYC_Management/KYC_Video/CheckBoxConfirmation/ChkKtpImage'), 10, FailureHandling.OPTIONAL)
    
    WebUI.click(findTestObject('Website/CRM/KYC_Management/KYC_Video/CheckBoxConfirmation/ChkKtpFace'), FailureHandling.OPTIONAL)
    
    WebUI.verifyElementChecked(findTestObject('Website/CRM/KYC_Management/KYC_Video/CheckBoxConfirmation/ChkKtpFace'), 10, FailureHandling.OPTIONAL)
    
    WebUI.click(findTestObject('Website/CRM/KYC_Management/KYC_Video/CheckBoxConfirmation/ChkPhotoCapture'), FailureHandling.OPTIONAL)
    
    WebUI.verifyElementChecked(findTestObject('Website/CRM/KYC_Management/KYC_Video/CheckBoxConfirmation/ChkPhotoCapture'),
	10, FailureHandling.OPTIONAL)
}

TestObject sectionAddress = new TestObject().addProperty('text', ConditionType.CONTAINS, textVerificationAddressSection)

if(WebUI.verifyElementPresent(sectionAddress, 20, FailureHandling.OPTIONAL) == true) {
    ...
    WebUI.waitForElementNotHasAttribute(findTestObject('Website/CRM/KYC_Management/KYC_Video/Details/DrpSubdistrict'), 'disabled', 10, FailureHandling.OPTIONAL)
    ...
    WebUI.waitForElementNotHasAttribute(findTestObject('Website/CRM/KYC_Management/KYC_Video/Details/DrpVillage'), 'disabled', 10, FailureHandling.OPTIONAL)
    ...
    WebUI.waitForElementNotHasAttribute(findTestObject('Website/CRM/KYC_Management/KYC_Video/Details/BtnKYCFinished'), 'disabled', 10, FailureHandling.OPTIONAL)
    
    WebUI.click(findTestObject('Website/CRM/KYC_Management/KYC_Video/Details/BtnKYCFinished'))
    
    WebUI.waitForElementNotPresent(findTestObject('Website/CRM/KYC_Management/KYC_Video/Details/BtnKYCFinished'), 5, FailureHandling.OPTIONAL)
}

TestObject sectionKYC = new TestObject().addProperty('text', ConditionType.CONTAINS, textVerificationKYCSection)

if (WebUI.verifyElementPresent(sectionKYC, 20, FailureHandling.OPTIONAL) == true) {
    WebUI.scrollToElement(findTestObject('Website/CRM/KYC_Management/KYC_Video/Details/ImgKTPKYC'), 10)
