...
/* We want to check from menu KYC Management page*/
...
WebUI.verifyElementPresent(menuKYCVerification, 5)

/* We want to click menu KYC verification page*/
...
/* We will capture KYC Verification */
