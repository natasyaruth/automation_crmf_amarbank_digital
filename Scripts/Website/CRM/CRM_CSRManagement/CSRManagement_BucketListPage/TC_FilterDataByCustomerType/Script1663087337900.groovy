...
/* We want to select  Filter Customer type "Nasabah Baru*/
WebUI.verifyElementVisible(FilterCustomerType, FailureHandling.OPTIONAL)

WebUI.selectOptionByLabel(FilterCustomerType, TxtNewRegistration, false)
...
WebUI.verifyTextPresent(TxtNewRegistration, false)

/* Take Screenshot*/
WebUI.takeScreenshot()

/* We want to select  Filter Customer type "Nasabah Senyumku*/
WebUI.verifyElementVisible(FilterCustomerType, FailureHandling.OPTIONAL)

WebUI.selectOptionByLabel(FilterCustomerType, TxtCustomerSenyumku, false)
...
WebUI.verifyTextPresent(TxtCustomerSenyumku, false)

/* Take Screenshot*/
WebUI.takeScreenshot()

/* We want to select  Filter Customer type "Nasabah Tidak Melanjutkan*/
WebUI.verifyElementVisible(FilterCustomerType, FailureHandling.OPTIONAL)

WebUI.selectOptionByLabel(FilterCustomerType, TxtDropOffCustomer, false)
...
WebUI.verifyTextPresent(TxtDropOffCustomer, false)
