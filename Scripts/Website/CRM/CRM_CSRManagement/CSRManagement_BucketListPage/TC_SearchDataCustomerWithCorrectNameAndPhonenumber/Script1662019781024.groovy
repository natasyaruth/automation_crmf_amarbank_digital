...
if(isObjectNotFound) {
	...
	keyLogger.markFailed("Customer with data "+custName+", and "+phoneNumber+" is not found")
	...
	if(actCustName.equals(custName)) {
		...
		if(actPhoneNumber.equals(phoneNumber)) {
			...
			WebUI.takeScreenshot()
			keyLogger.markPassed("Customer with data Fullname: "+custName+" and Phonenumber: "+phoneNumber+" is found")
			
		} else {
			
			/* Take screenshot, mark as failed case and print info message error*/
			WebUI.takeScreenshot()
			keyLogger.markFailed("Phonenumber customer with  fullname "+custName+" is not same")
