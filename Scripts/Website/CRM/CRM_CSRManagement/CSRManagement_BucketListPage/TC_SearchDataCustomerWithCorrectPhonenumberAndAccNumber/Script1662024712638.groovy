...
if(isObjectNotFound) {
	...
	keyLogger.markFailed("Customer with data "+phoneNumber+" and"+accNumber+" is not found")
	...
	* with expected phonenumber. */
	if(actPhoneNumber.equals(phoneNumber)) {
		...
		if(actAccNumber.equals(accNumber)) {
			...
			WebUI.takeScreenshot()
			keyLogger.markPassed("Customer with Phonenumber "+phoneNumber+" and Account number "+accNumber+" is found")
			
		} else {
			
			/* Take screenshot, mark as failed case and print info message error*/
			WebUI.takeScreenshot()
			keyLogger.markFailed("Account number customer with Phonenumber "+phoneNumber+" is not same")
