...
/* We want to check the conditional if we search by data not exist/not found*/
...
/* Verify data not found page*/
   WebUI.verifyElementVisible(DataNotFoundPage, FailureHandling.OPTIONAL)
   WebUI.verifyElementPresent(DataNotFoundPage, 15)
/* Take Screenshot*/
