...
if(isObjectNotFound) {
	...
	keyLogger.markFailed("Customer with Phonenumber "+phoneNumber+" is not found")
	...
	if(actPhoneNumber.equals(phoneNumber)) {
		...
		keyLogger.markPassed("Customer with Phonenumber "+phoneNumber+" is found")
		
	} else {
		
		/* Take screenshot, mark as failed case and print info message error*/
		WebUI.takeScreenshot()
		keyLogger.markFailed("Customer with Phonenumber "+phoneNumber+" is not same")
		
		println "Actual Phone Number : "+actPhoneNumber+"\n"
                "Expected Phone Number : "+phoneNumber
	}
}
