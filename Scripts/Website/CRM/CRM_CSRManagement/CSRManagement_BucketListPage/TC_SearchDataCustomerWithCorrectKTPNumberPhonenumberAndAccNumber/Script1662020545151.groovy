...
if(isObjectNotFound) {
	...
	keyLogger.markFailed("Customer with data "+ktpNumber+", "+phoneNumber+" and"+accNumber+" is not found")
	...
	* with expected phonenumber. */
	if(actPhoneNumber.equals(phoneNumber)) {
		...
		if(actAccNumber.equals(accNumber)) {
			...
			WebUI.takeScreenshot()
			keyLogger.markPassed("Customer with KTP Number: "+ktpNumber+", Phonenumber: "+phoneNumber+" and Account number: "+accNumber+" is found")
			
		} else {
			
			/* Take screenshot, mark as failed case and print info message error*/
			WebUI.takeScreenshot()
			keyLogger.markFailed("Account number customer with KTP Number "+ktpNumber+" and Phonenumber "+phoneNumber+" is not same")
		...
		/* Take screenshot, mark as failed case and print info message error*/
		WebUI.takeScreenshot()
		keyLogger.markFailed("Phonenumber customer is not same")
