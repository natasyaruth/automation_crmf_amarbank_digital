...
/*Showing all customer type filter*/
/* We want to verify element customer type"*/
WebUI.verifyElementPresent(drpCustomerType, 5)

/* Select option on filter Customer type "Nasabah Tidak Melanjutkan"*/
WebUI.selectOptionByLabel(drpCustomerType, CustomerType_DropOff, false)
