...
if(isObjectNotFound) {
	...
	keyLogger.markFailed("Customer with data "+ktpNumber+" and "+phoneNumber+" is not found")
	...
	/* The purpose of this conditional is to verify the actual phonenumber same
		...
		if(actPhoneNumber.equals(phoneNumber)) {
			...
			WebUI.takeScreenshot()
			keyLogger.markPassed("Customer with data KTP Number: "+ktpNumber+" and Phonenumber: "+phoneNumber+" is found")
			
		} else {
			
			/* Take screenshot, mark as failed case and print info message error*/
			WebUI.takeScreenshot()
			keyLogger.markFailed("Phonenumber customer with KTP Number "+ktpNumber+" is not same")
