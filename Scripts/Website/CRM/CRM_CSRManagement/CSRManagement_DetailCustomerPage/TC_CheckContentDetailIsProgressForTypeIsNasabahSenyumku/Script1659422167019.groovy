...
TestObject onProgressText = new TestObject().addProperty('text', ConditionType.CONTAINS , 'Dalam Proses')
boolean OnProgressText = WebUI.verifyElementPresent(onProgressText, 5)
if (OnProgressText == true) {
