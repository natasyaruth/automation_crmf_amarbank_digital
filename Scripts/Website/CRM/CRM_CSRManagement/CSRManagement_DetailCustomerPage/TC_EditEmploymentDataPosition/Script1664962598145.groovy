    ...
    if (WebUI.waitForElementVisible(elementEmploymentData, 5)) {
        ...
        if (dataPekerjaan == true) {
            ...
            if (WebUI.waitForElementVisible(DrpPosition, 5, FailureHandling.OPTIONAL)) {
                ...
                WebUI.verifyMatch(ChangelogField, FieldPosition  , false)
