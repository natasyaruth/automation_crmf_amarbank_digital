    ...
    if (WebUI.waitForElementVisible(elementDataDiri, 5)) {
        ...
        if (dataPekerjaan == true) {
            ...
            if (WebUI.waitForElementVisible(DrpMonthlyIncome, 5, FailureHandling.OPTIONAL)) {
                ...
                WebUI.verifyMatch(ChangelogField, FieldMonthlyIncome , false)
