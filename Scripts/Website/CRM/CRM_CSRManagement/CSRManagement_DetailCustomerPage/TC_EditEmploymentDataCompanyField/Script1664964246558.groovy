    ...
    if (WebUI.waitForElementVisible(elementEmploymentData, 5)) {
        ...
        if (dataPekerjaan == true) {
            ...
            if (WebUI.waitForElementVisible(DrpCompanyField, 5, FailureHandling.OPTIONAL)) {
                ...
                WebUI.verifyMatch(ChangelogField, FieldCompany , false)
