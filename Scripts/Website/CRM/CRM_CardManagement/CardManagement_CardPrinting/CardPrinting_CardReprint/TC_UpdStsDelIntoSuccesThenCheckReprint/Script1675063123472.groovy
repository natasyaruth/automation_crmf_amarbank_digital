...
hashNinjaVanSuccessfulPickup = SecureUtils.hmac_sha256("cf47ca4e44844cb987eb0577530a12a0",body.toString())

/* We want to store to global variable*/
GlobalVariable.hashNinjaVanSuccessfulPickup = hashNinjaVanSuccessfulPickup

/* We want to prepare the http request*/
def request = ((findTestObject('API/CRM/API_NinjaVanSuccessfulPickup', [('base_url_crm_otoku') : GlobalVariable.baseUrlRegOtoku, ('username') : GlobalVariable.usernameWebApi, ('password') : GlobalVariable.passwordWebApi, ('X-NINJAVAN-HMAC-SHA256') : hashNinjaVanSuccessfulPickup])) as RequestObject)
