...
/* We want to get ref id name from the first data*/
def getRefID = WebUI.getText(RefID, FailureHandling.STOP_ON_FAILURE)

/* We want to input ref id that want to search by*/
WebUI.setText(TextfieldSearchRefID, getRefID)
