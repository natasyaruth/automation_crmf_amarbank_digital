...
/* We want to expect blank value in City*/
WebUI.verifyElementHasAttribute(fieldDeliveryCityElement, "value", 5)

/* We want to verify field "Kecamatan"*/
WebUI.verifyElementPresent(fieldDeliverySuburbElement, 5)

/* We want to expect blank value in "Kecamatan"*/
WebUI.verifyElementText(fieldDeliverySuburbElement, fieldDeliverySuburbText)

/* We want to verify field "Kelurahan / Desa"*/
WebUI.verifyElementPresent(fieldDeliveryVillageElement, 5)

/* We want to expect blank value in "Kelurahan / Desa"*/
WebUI.verifyElementText(fieldDeliveryVillageElement, fieldDeliveryVillageText)
