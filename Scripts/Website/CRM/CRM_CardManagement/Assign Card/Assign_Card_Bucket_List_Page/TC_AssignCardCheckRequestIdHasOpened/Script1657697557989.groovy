...
/* We want to verify show pop up confirmation*/
WebUI.verifyElementPresent(popUpConfirmation, 5)

/* We want to verify text "Konfirmation" pop up notification*/
WebUI.verifyElementText(confirmationTextElement, confirmationText)

/* We want capture new card*/
WebUI.takeScreenshot()

/* We want to verify element button aboart */
WebUI.verifyElementText(btnAbortElement, btnAbortText)

/* We want to click button "batal"*/
WebUI.click(btnAbortElement)
