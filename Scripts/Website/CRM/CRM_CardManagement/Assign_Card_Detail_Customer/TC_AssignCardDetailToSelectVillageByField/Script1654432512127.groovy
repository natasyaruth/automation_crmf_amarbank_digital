...
/* We want to click the village for check the element*/
WebUI.click(fieldDeliveryVillageElement)

/* We want capture it*/
WebUI.takeScreenshot()

/* We want to count number total village of "Kecamatan (CINERE)" actual total is 5*/
totalOptionCinere = WebUI.getNumberOfTotalOption(fieldDeliveryVillageElement)

/* We want verify total is 5 of village 05/06/2022*/
WebUI.verifyEqual(totalOptionCinere, 5)
