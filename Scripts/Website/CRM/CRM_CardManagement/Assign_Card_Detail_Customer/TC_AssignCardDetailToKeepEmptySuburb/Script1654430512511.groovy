...
/* We want to click village field to trigger alert suburb*/
WebUI.click(fieldDeliveryVillageElement)

/* We want to check alert for suburb if empty field*/
WebUI.verifyElementText(alertEmptySuburbElement, alertEmptySuburbText)

/* We want to capture the data*/
...
WebUI.waitForElementVisible(fieldPostalCodeElement, 5)
