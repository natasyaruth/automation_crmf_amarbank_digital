...
/* We want to trigger alert from field city by click field suburb*/
WebUI.click(fieldDeliverySuburbElement)

/* We want to expect alert from city if empty*/
WebUI.verifyElementText(alertCityElement, alertCityText)
