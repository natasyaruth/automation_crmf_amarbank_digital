...
/* We want to get value from field postal code*/
getPostalCode = WebUI.getAttribute(fieldPostalCodeElement, "value")

/* We want to verify autofill for Postal Code "Kelurahan CINERE is 16514" */
WebUI.verifyEqual(getPostalCode, "16514")
