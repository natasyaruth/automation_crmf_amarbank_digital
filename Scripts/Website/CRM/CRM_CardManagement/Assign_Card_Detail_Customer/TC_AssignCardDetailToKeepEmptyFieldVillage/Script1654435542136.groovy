...
/* We want to click field postal code just trigger alert village*/
WebUI.click(fieldPostalCodeElement)

/* We want to check alert village text if empty*/
WebUI.verifyElementText(alertVillageElement, alertVillageText)
