...
/* We want to click the save button*/
WebUI.click(btnSaveAddressElement)

/* We want verify the error message from address delivery place*/
WebUI.verifyElementText(alertDeliveryAddressPlaceElement, alertDeliveryAddressPlaceText)
