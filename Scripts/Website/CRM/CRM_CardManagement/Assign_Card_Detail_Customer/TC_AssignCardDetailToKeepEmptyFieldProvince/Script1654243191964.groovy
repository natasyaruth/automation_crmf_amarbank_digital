...
/* We want trigger alert province by click element city*/
WebUI.click(fieldDeliveryCityElement)

/* We want to expect alert province show if blank field*/
WebUI.verifyElementText(alertProvinceElement, alertProvinceText)
