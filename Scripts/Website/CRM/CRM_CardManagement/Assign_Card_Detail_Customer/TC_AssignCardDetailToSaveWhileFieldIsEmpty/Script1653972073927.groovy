...
/* We want to check alert message from city*/
WebUI.verifyElementText(alertCityAddressElement, alertCityAddressText)

/* We want to check alert message from suburban*/
WebUI.verifyElementText(alertSuburbAddressElement, alertSuburbAddressText)

/* We want to check alert message from village*/
WebUI.verifyElementText(alertVillageAddressElement, alertVillageAddressText)
...
/* We want to cancel for edit delivery address*/
