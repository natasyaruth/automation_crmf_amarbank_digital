...
boolean check = WebUI.verifyElementChecked(chkAllPrint, 10)
...
if(check == true) {
	...
	for(int i=0;i<listCheckBoxPrintList.size();i++) {
		WebUI.verifyElementNotChecked(listCheckBoxPrintList.get(i), 10)
	}
}

/* We will verify if button 'Cetak kartu' is disabled */
WebUI.verifyElementNotClickable(btnCardPrint)