...
WebUI.setText(findTestObject('Website/CRM/Login/TxtGmailAccount'), GmailAccount)
...
WebUI.setText(findTestObject('Website/CRM/Login/TxtGmailPassword'), GmailPassword)
