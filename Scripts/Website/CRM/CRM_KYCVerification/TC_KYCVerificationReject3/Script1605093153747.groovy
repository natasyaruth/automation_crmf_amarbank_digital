...
WebUI.waitForElementVisible(findTestObject('Website/CRM/KYC_Management/KYC_Verification/Details/BtnReject3'), 10)

WebUI.click(findTestObject('Website/CRM/KYC_Management/KYC_Verification/Details/BtnReject3'))
