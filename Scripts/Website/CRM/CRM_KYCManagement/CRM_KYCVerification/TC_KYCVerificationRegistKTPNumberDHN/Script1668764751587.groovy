...
WebUI.verifyElementVisible(findTestObject('Website/CRM/KYC_Management/KYC_Verification/Details/TxtRejectedDHN2'))

WebUI.verifyElementClickable(findTestObject('Website/CRM/KYC_Management/KYC_Verification/Details/BtnBackToBucketlist'))
