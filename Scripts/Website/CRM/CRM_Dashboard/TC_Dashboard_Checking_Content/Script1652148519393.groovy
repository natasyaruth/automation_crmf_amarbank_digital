...
/* we want to check the element "terakhir gagal login" */
WebUI.verifyElementPresent(failedLoginElement, 10)

/* we want to identify test object with condition */
TestObject txtFailedLogin = new TestObject().addProperty('text', ConditionType.CONTAINS, failedLoginText)

/* we want to verify text login failed */
WebUI.verifyElementPresent(txtFailedLogin, 30)

/* we want to verify the element on success login*/
WebUI.verifyElementPresent(successLoginElement, 10)

/* we want to identify test objet with condition*/
TestObject txtSuccessLogin = new TestObject().addProperty('text', ConditionType.CONTAINS, successLoginText)

/* we want to verify text login success*/
WebUI.verifyElementPresent(txtSuccessLogin, 30)

/* we want to capture success and failed login*/
...
WebUI.verifyElementPresent(idleCallsTab, 5)
