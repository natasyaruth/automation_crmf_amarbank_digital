...
/*
 * This part I want to set RC 200 Cek data dukcapil
 * */
...
if (checkConditionMockServer == true) {
	...
	if (WebUI.waitForElementVisible(fieldInputKeyword, 5)) {
		...
		WebUI.setText(fieldInputKeyword, '[STAGING] CRMF GOV verify MOCK')
		
		WebUI.sendKeys(fieldInputKeyword, Keys.chord(Keys.ENTER))
		
		TestObject checkConfigAvailable = new TestObject().addProperty('text',ConditionType.CONTAINS,'[STAGING] CRMF GOV verify MOCK')	
		...
		if (isAvailable == true) {
			...
			if (isAvailaibleDrpDwn == true) {
				...
				String body = '{"name":100,"gender":0,"birthPlace":100,"birthDate":100,"motherMaidenName":100,"province":100,"region":100,"district":100,"subdistrict":100}'
			...
			keylogger.markFailed('Failed to Update Check Data Dukcapil')
