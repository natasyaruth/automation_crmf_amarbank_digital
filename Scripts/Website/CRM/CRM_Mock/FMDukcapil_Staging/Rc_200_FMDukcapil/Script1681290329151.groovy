	...
	if (WebUI.waitForElementVisible(fieldInputKeyword, 5)) {
		...
		if (isAvailable == true) {
			...
			if (isAvailaibleDrpDwn == true) {
				...
				String body = '{"Code":"200","StatusCode":200,"Err":null,"Data":{"error":null,"httpResponseCode":200,"matchScore":"6.12","quotaLimiter":999,"transactionId":"19949233830239239","uid":"7301010209680001","verificationResult":true}}'
