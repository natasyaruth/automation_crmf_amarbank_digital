...
/*
 * This part I want to set RC 500 Cek data verihub
 * */
	...
	if (WebUI.waitForElementVisible(fieldInputKeyword, 5)) {
		...
		if (isAvailable == true) {
			...
			if (isAvailaibleDrpDwn == true) {
				...
				WebUI.selectOptionByValue(drpDwnStatus, "500", false)
				
				String body = '{"code":1100,"message":"unexpected status: 404 Not Found","messageKey":"err.system.service.unavailable"}'
			...
			keylogger.markFailed('Failed to Update Data 500 Verihub V2')
