	...
	if (WebUI.waitForElementVisible(fieldInputKeyword, 5)) {
		...
		if (isAvailable == true) {
			...
			if (isAvailaibleDrpDwn == true) {
				...
				String body = '{"nameMatch":true,"birthDateMatch":true,"emailConflict":false,"phoneConflict":false,"selfieImageMatch":true,"identityImageMatch":true,"identityMatch":true,"status":"verified"}'
