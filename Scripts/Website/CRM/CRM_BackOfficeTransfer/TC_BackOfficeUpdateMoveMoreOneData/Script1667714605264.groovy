...
/*Step to process
	- Agen click more than one data checked but not all
	- Agen move others page
	- Agen click more than one data checked but not all in other page
	- Agen click and  chose new status for update
	- Agen click button update

/*Expected Result
	- Agen can click more than one data checked but not all in bucketlist
	- Agen can move to others page
	- Agen can click more than one data checked but not all in bucketlist others page
