...
WebUI.setText(findTestObject('Website/CRM/Card Management/Assign_Card/TxtCardNumber'), '')

WebUI.setText(findTestObject('Website/CRM/Card Management/Assign_Card/TxtCardName'), '')
